...
GameMainScene::GameMainScene() : high_score(NULL), back_ground(NULL), barrier_image(NULL), mileage(0), player(nullptr), enemy(nullptr)
{
	for (int i = 0; i < 3; i++)
	{
		enemy_image[i] = NULL;
...
void GameMainScene::Finalize()
{
	...
	FILE* fp = nullptr;
	//ファイルオープン
	errno_t resylt = fopen_s(&fp, "Resource/dat/result_data.csv", "w");
