...
void ResultScene::Draw() const
{
...

	{
		...
		DrawFormatString(260, 222 + (i * 21), GetColor(255, 255, 255), "%6d x%4d=%6d", enemy_count[i], (i + 1) * 50 * enemy_count[i], (i + 1) * 50 * enemy_count[i]);
	}
...
void ResultScene::ReadResultData()
{
	...
	if (result != 0)
	{
		throw("Resource/dat/result_data.csvが読み込みませ\n");
	}
